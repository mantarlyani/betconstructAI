...
insert into public.staff (name, role, login, pass) values
  ('Ани Петросян','Sales','ani.petrosyan','Kp7mQx2r'),
  ('Армен Казарян','Sales','armen.kazaryan','Zt4wLp9s'),
  ('Лилит Саркисян','Юрист','lilit.sarkisyan','Nb8vRy3k'),
  ('Нарек Аветисян','Service Sales','narek.avetisyan','Sd5xQe1m'),
  ('Давид Хачатрян','PM','david.khachatryan','Pm9kLt4w'),
  ('Гор Мнацаканян','Account Manager','gor.mnatsakanyan','Am3zBv7n')
